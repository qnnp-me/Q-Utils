...
var __generator = (
  ...
  function step (op) {
    ...
    while (g && (
      ...
      try {
        if (f = 1, y && (
          t = op[0] & 2 ? y['return'] : op[0] ? y['throw'] || (
            (
              t = y['return']
            ) && t.call(y), 0
          ) : y.next
          ...
          switch (_e.label) {
            case 0:
              ...
              if (!authType || authType === 'cookie') {
                options.header = __assign(
                  __assign({}, options.header),
                  {
                    cookie: ''.concat(authKey || 'token', '=')
                              .concat(token, '; ')
                              .concat((
                                      (
                                        _d = options.header
                                      ) === null || _d === void 0 ? void 0 : _d.cookie
                                      ) || '')
                  }
                )
              } else if (authType === 'header') {
                options.header = __assign((
                  _c = {}, _c[authKey || 'Authorization'] = token, _c
                ), options.header)
              }
              fail = function (err) {
...
var OPTIONS            = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'OPTIONS', url: url, data: data }), listen)
}
exports.OPTIONS        = OPTIONS
var GET                = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'GET', url: url, data: data }), listen)
}
exports.GET            = GET
var HEAD               = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'HEAD', url: url, data: data }), listen)
}
exports.HEAD           = HEAD
var POST               = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'POST', url: url, data: data }), listen)
}
exports.POST           = POST
var PUT                = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'PUT', url: url, data: data }), listen)
}
exports.PUT            = PUT
var DELETE             = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'DELETE', url: url, data: data }), listen)
}
exports.DELETE         = DELETE
var TRACE              = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'TRACE', url: url, data: data }), listen)
}
exports.TRACE          = TRACE
var CONNECT            = function (url, data, options, listen) {
  return (
    0, exports.REQUEST
  )(__assign(__assign({}, options), { method: 'CONNECT', url: url, data: data }), listen)
}
        ...
        case 0:
          ...
          if (!(
            !(
              (
                _a = options.method
              ) === null || _a === void 0 ? void 0 : _a.match(/GET|HEAD/)
            )
            && (
              (
                _b = options.header
              ) === null || _b === void 0 ? void 0 : _b['content-type']
            ) === 'multipart/form-data'
            && typeof data === 'object'
            && (
              0, helpers_1.getType
